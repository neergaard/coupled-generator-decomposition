...
class PathConfig:
    ...
    PROJECT = Path("/mrhome/jesperdn/INN_JESPER/projects/facerecognition")

# From anateeg project
    MATLAB_FUNCTIONS = Path("/home/jesperdn/project_tools/matlab/projects/anateeg")
    FMRI_FUNCTIONS = Path(
        "/home/jesperdn/project_tools/matlab/projects/facerecognition"
    )

    DATA = PROJECT / "data"
    RESOURCES = PROJECT / "resources"
    RESULTS = PROJECT / "results"
    SIMNIBS_CHARM = PROJECT / "simnibs_charm"
