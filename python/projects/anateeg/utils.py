...
class IO:
    def __init__(self, kwargs):
        ...
        self.simnibs = dict(
            charm=SimnibsOrganizer(Config.path.SIMNIBS),
            reference=SimnibsOrganizer(Config.path.SIMNIBS_REFERENCE),
            template=SimnibsOrganizer(Config.path.SIMNIBS_TEMPLATE),
        )
