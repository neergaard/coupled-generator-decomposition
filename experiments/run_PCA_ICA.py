...
for K in range(2,31):
    ...
    U_group_pca,Sigma_group_pca,V_group_pca = torch.pca_lowrank(Xtrain1['group_spca'],q=K,niter=100)
    group_pca_test_loss = torch.norm(Xtest1['group_spca']-U_group_pca@torch.diag(Sigma_group_pca)@V_group_pca.T)**2
    ...
    A_group_ica,S_group_ica,_ = ica1(x_raw=Xtrain1['group_spca'],ncomp=K)
