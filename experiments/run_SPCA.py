...
def run_model(M,K):
    ...
    Xtrain = {'group_spca':Xtrain_group_spca,'mm_spca':Xtrain_mm,'mmms_spca':Xtrain_mmms,'mmms_DAA':Xtrain_mmms}
    ...
    Xtest = {'group_spca':Xtest_group_spca,'mm_spca':Xtest_mm,'mmms_spca':Xtest_mmms,'mmms_DAA':Xtest_mmms}
